...
module.exports = function outputHelp(argv) {
    var helpInfo = 'Usage: znpm [option] <command>\n' +
        'Help: 稳贤哥 || http://cnpmjs.org/help/cnpm\n\n' +
        '  Extend command\n' +
        '    web                            打开私有npm网站 (ex.: znpm web)\n' +
        '    check [ingoreupdate]           检查当前目录下的package.json的依赖包的更新情况, 默认检测devDependencies，(check dep)查看dependencies\n' +
        ...
        '  npm command use --registry=' + (argv.registry || config.npmRegistry) + '\n' +
